...
const CampgroundUpdateForm = ({ validateForm }) => {
  ...
  return (
    <div className='CampgroundUpdateForm'>
      <div className='CampgroundUpdateForm__title'>
        <Input
          element='input'
          type='text'
          placeholder='title...'
      ...
      <div className='CampgroundUpdateForm__location'>
        <Input
          element='input'
          type='text'
      ...
      <div className='CampgroundUpdateForm__description'>
        <Input
          element='textarea'
          type='text'
          rows='5'
      ...
      <div className='CampgroundUpdateForm__price'>
        <Input
          element='input'
          type='number'
          placeholder='price...'
...
export default connect(mapStateToProps, formActions)(CampgroundUpdateForm);
